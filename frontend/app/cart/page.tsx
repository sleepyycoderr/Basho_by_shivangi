          ...
          <div className="grid lg:grid-cols-3 gap-8">
                  ...
                  <div className="flex gap-6">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-start mb-2">
                        ...
                        {/* Delete Button */}
                        <button
                          onClick={() => removeFromCart(item.product.id, item.selectedColor.code)}
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-sm shadow-sm p-6 sticky top-24">
                <h2 className="text-xl font-serif text-[#2C2C2C] mb-6">Order Summary</h2>
                ...
                <div className="flex justify-between items-baseline mb-6">
                  ...
                  <span className="text-3xl font-semibold text-[#8B6F47]">{formatPrice(total)}</span>
                </div>
