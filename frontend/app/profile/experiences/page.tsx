  ...
  if (loading) {
    return (
      <main className="min-h-screen bg-[#FAF8F5] flex items-center justify-center">
        <p className="font-serif text-[#563a13]">Loading your experiences…</p>
      </main>
    );
  }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p className="text-[#4A5F55] text-sm">
            Your booked clay rituals & curated sessions
          </p>
        </div>

        {data.length === 0 && (
          <div className="bg-[#FFFDF9] border border-[#A8A29E]/20 rounded-sm p-10 text-center">
            <p className="text-[#4A5F55]">You haven’t booked any experiences yet.</p>
          </div>
        )}
          ...
          {data.map(e => (
            ...
            >
              ...
              <div className="text-sm text-[#4A5F55] space-y-1">
                <p>
                  Amount: <span className="text-[#563a13] font-medium">₹{e.amount}</span>
                </p>
